<?php
    class InventoryB{
        ...
        public function GetLatestPerformance($product_id){
            ...
            // )";
            $sql = "SELECT performance FROM inventory_performance WHERE product_id = {$product_id} ORDER BY id DESC LIMIT 1";
            $db = new database;
        ...
        public function GetLatestInventory($inventory_id){
            $sql = "SELECT * FROM inventory_management WHERE inventory_id = {$inventory_id} ORDER BY id DESC LIMIT 1";
            $db = new database;
            $result = $db->select($sql);
            return $result;
        }
